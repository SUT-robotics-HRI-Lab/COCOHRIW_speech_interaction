...
public:
    ...
    void leap_frame_callback(const LeapFrame::SharedPtr msg)
    {
        ...
        for (const auto &info : environment_objects_)
        {
            ...
            //Debug print which object is intersected
...
private:
    ...
    void initialize_environment()
    {
        ...
        o1.y = 0.39;
        o1.z = 0.0;
        environment_objects_.push_back(ObjectInfo("vial", o1, 0.03, 0.23));
        geometry_msgs::msg::Point o2;
        o2.x = 1.203;
        o2.y = 0.3028;
        o2.z = 0.0;
        environment_objects_.push_back(ObjectInfo("bottle", o2, 0.04, 0.23));
        geometry_msgs::msg::Point o3;
        o3.x = 0.876;
        o3.y = 0.4198;
        o3.z = 0.0;
        environment_objects_.push_back(ObjectInfo("flask", o3, 0.045, 0.23));
        geometry_msgs::msg::Point o4;
        o4.x = 0.677;
        o4.y = 0.4177;
        o4.z = 0.0;
        environment_objects_.push_back(ObjectInfo("cylinder", o4, 0.03, 0.23));
